...
namespace _17_Constructors_Yapıcılar_
{
    class Program
    {
        ...
        //Buradaki kod satırına constructor denir. new edilen bir metoda constructor denir.
        {
            ...
            Customer customer2 = new Customer(1, "Arda", "Ağdemir", "Anakra"); //bu şekilde de yazılabilir.
            //Bğer yukarıdaki(customer2) gibi kullanmak isteniyorsa default customer da bu belirtilmelidir.
